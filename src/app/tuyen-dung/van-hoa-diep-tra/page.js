        ...
        <Flex w="full" direction="column">
          ...
          <Box mt={{ xs: '24px', lg: '48px' }}>
            ...
            <Text fontWeight={400} fontSize={18} lineHeight="19px" mt="12px">
              {'- Chương trình đào tạo và học tập liên tục:'} {'Diệp Trà tạo điều kiện để nhân viên tham gia các khóa học, hội thảo chuyên môn cả trong nước và quốc tế. Từ đó, nhân sự không chỉ phát triển kỹ năng công việc mà còn mở rộng tư duy sáng tạo và hiểu biết ngành.'}
            </Text>
            ...
            <Text fontWeight={400} fontSize={18} lineHeight="19px" mt="12px">
              {'- Đánh giá sự tiến bộ cá nhân:'} {'Thành công của nhân viên không chỉ dựa trên kết quả công việc mà còn được đo lường qua sự tiến bộ cá nhân, khả năng vượt qua thử thách, và cách họ hỗ trợ đồng đội.'}
            </Text>
            ...
            <Text fontWeight={400} fontSize={18} lineHeight="19px" mt="12px">
              {'- Đội ngũ đa dạng và tôn trọng lẫn nhau:'} {'Diệp Trà tự hào sở hữu một đội ngũ nhân sự đa dạng về kinh nghiệm, góc nhìn, và văn hóa. Nhân viên được khuyến khích học hỏi từ nhau để phát triển cả về cá nhân lẫn tập thể.'}
            </Text>
            ...
            <Flex pl={{ xs: '20px', lg: '40px' }} mt="8px">
              <Text fontWeight={400} fontSize={18} lineHeight="19px">
                ...
                <br />
                {'+ Phối hợp liên phòng ban, đoàn kết vì mục tiêu và sứ mệnh chung của công ty.'}
              </Text>
            </Flex>

            <Text fontWeight={400} fontSize={18} lineHeight="19px" mt="12px">
              {'- Tôn vinh mọi ý tưởng:'} {'Mọi thành viên, dù ở bất kỳ vị trí nào, đều được khuyến khích chia sẻ ý tưởng. Diệp Trà lắng nghe và đánh giá cao những đóng góp này như một phần của quá trình cải tiến.'}
            </Text>
            ...
            <Text fontWeight={400} fontSize={18} lineHeight="19px" mt="12px">
              {'- Chương trình động viên học tập:'} {'Công ty xây dựng các chính sách thưởng khuyến khích việc học tập như hỗ trợ chi phí khóa học, tạo cơ hội thực hành tại chỗ, và tổ chức các buổi chia sẻ kinh nghiệm.'}
            </Text>
            ...
            <Text fontWeight={400} fontSize={18} lineHeight="19px" mt="12px">
              {'- Không gian cho ý tưởng:'} {'Diệp Trà khuyến khích nhân sự đề xuất ý tưởng mới, từ sản phẩm đến quy trình làm việc hay các hoạt động nội bộ. Mọi ý tưởng đều được xem xét, thảo luận và triển khai nếu phù hợp.'}
            </Text>
            ...
            <Text fontWeight={400} fontSize={18} lineHeight="19px" mt="12px">
              {'- Kết nối cộng đồng:'} {'Diệp Trà tổ chức các chương trình hỗ trợ khách hàng và cộng đồng, như hội thảo chia sẻ kiến thức ngành đồ uống, chiến dịch nâng cao nhận thức về nguyên liệu chất lượng, và các sự kiện từ thiện.'}
            </Text>

            <Text fontWeight={400} fontSize={18} lineHeight="19px" mt="12px">
              {'- Chương trình kết nối cộng đồng:'} {'Phối hợp với các quán cà phê, trà sữa và doanh nghiệp nhỏ để tổ chức các hội thảo, workshop hàng tuần, hàng tháng nâng cao chất lượng đồ uống, đồng thời giới thiệu sản phẩm của Diệp Trà.'}
            </Text>

            <Text fontWeight={400} fontSize={18} lineHeight="19px" mt="12px">
              {'- Trách nhiệm xã hội:'} {'Công ty không chỉ tập trung vào kinh doanh mà còn cam kết đóng góp vào sự phát triển bền vững của xã hội thông qua các hoạt động thiện nguyện và các sáng kiến bảo vệ môi trường.'}
            </Text>
