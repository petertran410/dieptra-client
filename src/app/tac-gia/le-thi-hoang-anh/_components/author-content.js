...
const EXPERIENCE = [
  {
    ...
    p: 'Có kinh nghiệm xây dựng và vận hành thương hiệu nguyên liệu pha chế, từ lựa chọn sản phẩm, định vị phân khúc, xây dựng thông điệp bán hàng đến hỗ trợ đại lý và khách hàng B2B.'
  },
  {
    n: '02',
    h: 'Tư vấn menu & công thức đồ uống',
    p: 'Đồng hành cùng quán trong việc lên menu trà sữa, trà trái cây, trà kem, đồ uống topping, đồ uống theo mùa và các công thức phù hợp với khẩu vị khách hàng Việt Nam.'
  },
  {
    n: '03',
    h: 'Nghiên cứu topping & ứng dụng sản phẩm',
    p: 'Trực tiếp nghiên cứu các dòng topping như trân châu, mochi, thạch, hạt nổ, tàu hũ, khoai môn nghiền và các giải pháp topping đông lạnh dùng trong pha chế hiện đại.'
  },
  {
    n: '04',
    h: 'Làm việc với quán trà sữa & chuỗi F&B',
    p: 'Hiểu các vấn đề thực tế của quán: giá vốn, tốc độ ra món, tính ổn định nguyên liệu, khẩu vị khách hàng, đào tạo nhân sự và cách triển khai món mới hiệu quả.'
  },
  {
    n: '05',
    h: 'Phân phối nguyên liệu & hỗ trợ đại lý',
    p: 'Có kinh nghiệm phân phối nguyên liệu pha chế, làm việc với khách hàng sỉ, đại lý, đối tác vùng và các mô hình cần giải pháp nguồn hàng ổn định, dễ bán, dễ ứng dụng.'
  },
  {
    n: '06',
    h: 'Cập nhật xu hướng đồ uống',
    p: 'Theo dõi xu hướng đồ uống tại Việt Nam, Trung Quốc và các thị trường nguyên liệu lớn, từ đó chọn lọc ý tưởng phù hợp để đưa vào công thức, workshop và tài liệu tư vấn.'
  }
];
...
const SOCIALS = [
  {
    ico: 'f',
    name: 'Facebook',
    desc: 'Cập nhật sản phẩm, workshop, phản hồi khách hàng',
    ...
    <HomeTheme>
      ...
      >
        <Box
          ...
          h="520px"
          borderRadius="50%"
          bg="radial-gradient(circle, rgba(0,183,204,.18), rgba(0,183,204,0))"
          pointerEvents="none"
        />
        <Box
          pos="absolute"
          ...
          h="420px"
          borderRadius="50%"
          bg="radial-gradient(circle, rgba(255,122,26,.12), rgba(255,122,26,0))"
          pointerEvents="none"
        />

        <Box px={HOME_PX} pos="relative" zIndex={1}>
          <Grid
            templateColumns={{ base: '1fr', lg: 'minmax(0,1.12fr) minmax(340px,420px)' }}
          ...
          >
            <MotionBox {...reveal} minW={0}>
              ...
              <Text fontSize="17px" color={HC.textSecondary} maxW="640px" mb="18px" fontWeight={500}>
                ...
                bám sát nhu cầu thực tế của chủ quán, barista, đại lý nguyên liệu và đội ngũ phát triển sản phẩm trong
                ngành đồ uống.
              </Text>
            ...
            >
              ...
              >
                <Box>
                  <Text as="strong" color={HC.primaryDark} fontFamily={FONT_DISPLAY} fontWeight={700}>
                    Họ tên:
                  </Text>{' '}
                  Lê Thị Hoàng Anh
                </Box>
      ...
      <Box as="section" px={HOME_PX} mt={{ base: '-30px', lg: '-44px' }} position="relative" zIndex={5}>
        ...
        >
          {USP.map((it, i) => (
            ...
            >
              <Text fontFamily={FONT_DISPLAY} fontSize="34px" fontWeight={900} color={HC.accent} lineHeight={1}>
                {it.num}
              </Text>
              <Text
                fontFamily={FONT_DISPLAY}
              ...
              <Text fontSize="12.5px" color={HC.textMuted} lineHeight={1.5}>
                {it.desc}
              </Text>
            </Box>
          ))}
          ...
          <Grid templateColumns={{ base: '1fr', md: 'repeat(2, 1fr)', lg: 'repeat(3, 1fr)' }} gap="24px">
            {EXPERIENCE.map((c, i) => (
              <MotionBox
                ...
                _hover={{ transform: 'translateY(-6px)', boxShadow: HC.shadowCard }}
              >
                <Flex
                  w="50px"
                  h="50px"
                ...
                <Text color={HC.textSecondary} fontSize="14.5px">
                  {c.p}
                </Text>
              </MotionBox>
            ))}
        ...
        <Box maxW="1200px" mx="auto" pos="relative" zIndex={2}>
          ...
          >
            <MotionBox
              ...
              boxShadow="0 22px 48px rgba(0,23,42,.3)"
            >
              <Box
                as="img"
                src="/images/home-v2/author-avatar.webp"
            ...
            {JOURNEY.map((j, i) => (
              <MotionBox
                ...
                sx={{
                  ...
                  '&:hover': { transform: 'translateY(-6px)', boxShadow: HC.shadowCard },
                  '&:hover .j-img': { transform: 'scale(1.05)' }
                }}
              >
                ...
                <Box p="22px">
                  ...
                  <Text color={HC.textSecondary} fontSize="14px" lineHeight={1.6}>
                    {j.p}
                  </Text>
                </Box>
              </MotionBox>
      ...
      <Box as="section" px={HOME_PX} py={{ base: '56px', lg: '96px' }}>
        ...
        >
          <Flex
            ...
            fontWeight={900}
            lineHeight={1}
            boxShadow="0 12px 26px rgba(13,59,66,.1)"
          >
            “
          </Flex>
          <Box>
          ...
          <Grid templateColumns={{ base: '1fr', md: 'repeat(2, 1fr)', lg: 'repeat(4, 1fr)' }} gap="20px">
            {SOCIALS.map((s, i) => (
              ...
              >
                ...
                <Text as="span" display="block" color={HC.textMuted} fontSize="13.5px" lineHeight={1.55}>
                  {s.desc}
                </Text>
              </MotionBox>
            ))}
      ...
      >
        ...
        >
          ...
          <Box pos="relative" zIndex={1}>
            ...
            <Text color={HC.cyanSoft} fontSize="16.5px">
          ...
          <Flex justify={{ base: 'flex-start', lg: 'flex-end' }} gap="12px" flexWrap="wrap" pos="relative" zIndex={1}>
            <Box
              ...
              bg="#fff"
              color={HC.primaryDeep}
              transition="all .2s"
              _hover={{ bg: HC.accent, color: '#fff', borderColor: HC.accent }}
            >
              Liên hệ Diệp Trà →
            </Box>
            <Box
