    ...
    >
      ...
      <Text fontSize={18}>
        ...
        <Text fontSize={18}>
          ...
          Trà với tầm nhìn tiên phong, đi đầu trong ngành Đồ uống tại Việt Nam. Chúng tôi chuyên cung cấp nguyên liệu
          pha chế nhập khẩu từ Đài Loan (Trung Quốc) và Trung Quốc, tập trung vào chiến lược phát triển{' '}
          ...
          <Text as="span" fontSize={18} fontWeight={500} color="#1E96BC">
            hệ sinh thái toàn diện, từ những sản phẩm có chất lượng tốt nhất, độc đáo theo xu hướng với chi phí tối ưu
            đến cách phát triển menu đa dạng, cập nhật từ các chuyên gia hàng đầu tại xứ sở Trà sữa.
          </Text>
        </Text>
        <br />
        <br />
        <Text fontSize={18}>
          ...
          chuẩn nghiêm ngặt:{' '}
          <Text as="span" fontSize={18} fontWeight={500} color="#1E96BC">
            Chất lượng tốt nhất, Công nghệ tiên tiến, Thời gian giao nhận, Khả năng cung ứng liên tục, Chính sách bảo
            hành và Giá thành cạnh tranh.
          </Text>
          <br />
          <br />
          Vị thế là nhà nhập khẩu hàng đầu tại Việt Nam, chúng tôi đã không ngừng bứt phá mạnh mẽ, khai phá tiềm năng
          thị trường và nâng cao tiêu chuẩn chất lượng đề mang đến giải pháp toàn diện, đáp ứng tối đa kỳ vọng của khách
          hàng. Theo đuổi tôn chỉ luôn lắng nghe và không ngừng cải tiến, Diệp Trà đã nhận được sự tin tưởng đồng hành
          của khách hàng trong việc nâng tầm menu và hành trình tạo dựng những thương hiệu thành công.
        </Text>
        <br />
        <br />
