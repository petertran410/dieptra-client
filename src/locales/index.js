export const translations = {
  ...
  en: {
    ...
    'payment.complete.title': 'Complete order',
    ...
    'payment.fullName.place': 'Enter full name',
    'payment.email.place': 'Enter email address',
    'payment.phone': 'Phone number',
    'payment.phone.place': 'Enter phone number',
    'payment.province': 'Province/City',
    'payment.province.place': 'Select province/city',
    'payment.district': 'District',
    'payment.district.place': 'Select district/county',
    'payment.ward': 'Ward/Commune',
    'payment.ward.place': 'Select ward/commune',
    'payment.address': 'Specific address',
    'payment.address.place': 'House number, street name...',
    'payment.order.note': 'Order note',
    'payment.order.note.place': 'Order note (optional)',
    'payemnt.order.information': 'Order information',
    'payment.provisional.calculation': 'Provisional calculation:',
    'payment.shipping.unit': 'Shipping unit:',
    ...
    'payment.link.connect': 'Click on the link to pay',
