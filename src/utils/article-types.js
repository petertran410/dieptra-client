export const ARTICLE_TYPES = {
  ...
  CULTURE_EN: 'CULTURE',
  VIDEO_EN: 'VIDEO',
  KIEN_THUC_NGUYEN_LIEU_EN: 'KIEN_THUC_NGUYEN_LIEU',
  KIEN_THUC_TRA_EN: 'KIEN_THUC_TRA',
  TREND_PHA_CHE_EN: 'TREND_PHA_CHE',
  REVIEW_SAN_PHAM_EN: 'REVIEW_SAN_PHAM',
  CONG_THUC_PHA_CHE_EN: 'CONG_THUC_PHA_CHE'
};
