...
export const POLICY_PAGES = {
  ...
  'chinh-sach-mua-hang': {
    ...
    content: `
      ...
      <h2>2/ Hướng dẫn mua hàng</h2>
      <p>Quý khách có thể lựa chọn một trong các cách sau để đặt hàng:</p>
      
      <h3>2.1 Mua hàng trực tiếp tại cửa hàng</h3>
  ...
  'chinh-sach-thanh-toan': {
    ...
    content: `
      ...
      <h3>1.1. Thanh toán khi nhận hàng (COD – Cash On Delivery)</h3>
      <ul>
      ...
      <h3>1.2. Thanh toán chuyển khoản ngân hàng</h3>
      ...
      <h2>2/ Quy định xác nhận thanh toán</h2>
      <ul>
  ...
  'chinh-sach-giao-hang': {
    ...
    content: `
      ...
      <h2>5/ Chính sách kiểm tra hàng</h2>
      ...
      <h2>6/ Trường hợp giao hàng thất bại</h2>
      ...
      <h2>7/ Giao hàng nhiều lần – giao hàng đặc biệt</h2>
      <ul>
  ...
  'chinh-sach-doi-hang-tra-hang': {
    ...
    content: `
      ...
      <h2>3/ Điều kiện hàng hóa được đổi/trả</h2>
  ...
  'dieu-khoan-su-dung': {
    ...
    content: `
      ...
      <h2>2/ Quy định sử dụng website</h2>
      <ul>
      ...
      <h2>5/ Chính sách sản phẩm & dịch vụ</h2>
      <ul>
      ...
      <h2>6/ Điều khoản về bản quyền</h2>
      <ul>
